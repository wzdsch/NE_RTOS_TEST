/**
  ...
  * @file       crc8_crc16.c/h
  * @brief      crc8 and crc16 calculate function, verify function, append
  function.
  *             crc8��crc16���㺯��,У�麯��,���Ӻ���
  * @note
  * @history
...
/**
  ...
  * @retval         �������CRC8
  */
extern uint8_t get_CRC8_check_sum(unsigned char *pchMessage,
...
/**
  ...
  * @retval         ����߼�
  */
extern uint32_t verify_CRC8_check_sum(unsigned char *pchMessage,
