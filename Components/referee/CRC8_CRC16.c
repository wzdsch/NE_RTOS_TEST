...
/**
  ...
  */
uint8_t get_CRC8_check_sum(unsigned char *pch_message, unsigned int dw_length,
...
/**
  ...
  */
uint32_t verify_CRC8_check_sum(unsigned char *pch_message,
...
void append_CRC8_check_sum(unsigned char *pch_message, unsigned int dw_length) {
  ...
  ucCRC = get_CRC8_check_sum((unsigned char *)pch_message, dw_length - 1,
                             CRC8_INIT);
...
/**
  ...
  */
uint16_t get_CRC16_check_sum(uint8_t *pch_message, uint32_t dw_length,
                             uint16_t wCRC) {
  uint8_t chData;
  if (pch_message == NULL) {
    return 0xFFFF;
