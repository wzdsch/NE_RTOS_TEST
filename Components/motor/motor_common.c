 ...
 * @LastEditTime: 2025-11-05 21:23:50
...
void _MotorCommon_PID_Calc(MotorCommon_t *p_motor_common)
{
  ...
  int16_t err_ecd = p_motor_common->measure_data.pos_ecd - p_motor_common->ctrl_data.set_target.set_pos_ecd;
  ...
  case MOTOR_CTRL_LOOP_POS_SPD:
    ...
    PID_Calc(&p_motor_common->pid_pos, err_ecd, 0);
  ...
  case MOTOR_CTRL_LOOP_POS:
    ...
    p_motor_common->pid_out = PID_Calc(&p_motor_common->pid_pos, err_ecd, 0);
  ...
  case MOTOR_CTRL_LOOP_TOR:
    p_motor_common->pid_out = PID_Calc(&p_motor_common->pid_tor, p_motor_common->measure_data.tor, p_motor_common->ctrl_data.set_target.set_tor);
    break;
  case MOTOR_CTRL_TOR:
    p_motor_common->pid_out = p_motor_common->ctrl_data.set_target.set_tor;
    break;
